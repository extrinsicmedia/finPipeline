...
class MayaObjectError(cmds.TypeError):
    """
    #--------------------------
    # PyNode Exceptions
    #--------------------------
...
class Attribute(PyNode):
    ...
    def disconnect(source, destination=None, **kwargs):
        """
...
class AttributeDefaults(PyNode):
    ...
    def accepts(self, type):
        ...
        :Parameters:
            type : `Data.Type`
                ...
                values: 'numeric', 'plugin', 'pluginGeometry', 'string', 'matrix', 'stringArray', 'doubleArray', 'intArray', 'pointArray', 'vectorArray', 'componentList', 'mesh', 'lattice', 'nurbsCurve', 'nurbsSurface', 'sphere', 'dynArrayAttrs', 'dynSweptGeometry', 'subdSurface', 'NObject', 'NId'
    ...
    def setParent(self, parent):
        ...
        Derived from api method `maya.OpenMaya.MFnAttribute.setParent`
        """
...
def about(**kwargs):
    ...
    Flags:
      ...
      - windowManager : wm             (bool)          [create]
          Returns the name of the Window Manager that is assumed to be running.                     Flag can have multiple
...
def affectedNet(*args, **kwargs):
    ...
    Flags:
      ...
      - type : t                       (unicode)       [create]
          Get information from the given node type instead of one node                      Flag can have multiple arguments,
...
def align(*args, **kwargs):
    ...
    Flags:
      ...
      - coordinateSystem : cs          (PyNode)        [create]
          Defines the X, Y, and Z coordinates. Default is the world coordinates                                     Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def assignCommand(*args, **kwargs):
    ...
    Flags:
      ...
      - sourceUserCommands : suc       (bool)          [edit]
          This command sources the user named command file.                         Flag can have multiple arguments, passed
...
def attributeQuery(*args, **kwargs):
    ...
    Flags:
      ...
      - niceName : nn                  (bool)          [create]
          Return the nice name (or UI name) of the attribute.                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def commandEcho(*args, **kwargs):
    ...
    Flags:
      ...
      - lineNumbers : ln               (bool)          [create,query]
          ...
          and line number information is provided in error and warning messages.                   Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def commandPort(*args, **kwargs):
    ...
    Flags:
      ...
      - pickleOutput : po              (bool)          [create]
          Python output will be pickled.                    Flag can have multiple arguments, passed either as a tuple or a list.
...
def connectionInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - getLockedAncestor : gla        (bool)          [create]
          ...
          are locked, an empty string is returned.                          Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def containerBind(*args, **kwargs):
    ...
    Flags:
      ...
      - bindingSetConditions : bsc     (bool)          [query]
          ...
          to the container's list of published names, bound or unbound state, etc.                                      Flag can
...
def containerProxy(*args, **kwargs):
    ...
    doExportContainerProxy.mel script which is invoked by the Export Container Proxymenu item.
    ...
    Flags:
      ...
      - type : typ                     (unicode)       [create]
          ...
          container. The default value for this flag is 'container'.                                         Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def containerPublish(*args, **kwargs):
    ...
    Flags:
      ...
      - bindTemplateStandins : bts     (bool)          [create,query,edit]
          ...
          bound. This enables you to set values for unbound attributes.                                      Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def containerTemplate(*args, **kwargs):
    ...
    Flags:
      ...
      - layoutMode : lm                (int)           [create]
          ...
          The fromContainer argument is required to provide the reference container for layout modes that require node
          information.  Note that views can only refer to defined template attributes.  This means that when using the
          fromContainer flag to add a view to an existing template, only attributes that are defined on both the template and the
          container will be included in the view (i.e. published attributes on the container that are not defined in the template
          will be ignored).
      ...
      - silent : si                    (bool)          [create,query,edit]
          ...
          return values are unaffected.                                    Flag can have multiple arguments, passed either as a
          tuple or a list.
      ...
      - unload : u                     (bool)          [create]
          ...
          removes the template definition from the current session. Use the delete action if permanent deletion is required.
...
def containerView(*args, **kwargs):
    ...
    Flags:
      - itemInfo : ii                  (unicode)       [query]
          ...
          of this itemitemAttrType : item attribute type (string)
      ...
      - viewDescription : vd           (bool)          [query]
          Used in query mode, returns the description field associated with the currently active view. If no description was
          defined for this view, the value will be empty.                                        Flag can have multiple arguments,
          passed either as a tuple or a list.
      ...
      - viewLabel : vb                 (bool)          [query]
          ...
          interface will be returned based on the current container settings.  Use of the view label is usually more suitable than
          the view name for display purposes.
    
      - viewList : vl                  (bool)          [query]
          Used in query mode, command will return a list of all views defined for this container.
    
      - viewName : vn                  (bool)          [query]
          Used in query mode, returns name of the currently active view associated with the container.  This value may be empty if
          the current view is not a valid template view or is generated by one of the built-in view modes. For this reason, the
          view label is generally more suitable for display purposes.
...
def contextInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - image3 : i3                    (bool)          [create]
          Returns the name of an xpm associated with the named context.                     Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def createDisplayLayer(*args, **kwargs):
    ...
    Flags:
      ...
      - number : num                   (int)           [create]
          Number for the new display layer being created.                                           Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def createNode(*args, **kwargs):
    ...
    Flags:
      ...
      - skipSelect : ss                (bool)          [create]
          This node is not to be selected after creation, the original selection will be preserved.                         Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def currentUnit(*args, **kwargs):
    ...
    Flags:
      ...
      - updateAnimation : ua           (bool)          [create]
          ...
          12ntsc. Default is -updateAnimation true.                         Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def displayColor(*args, **kwargs):
    ...
    Flags:
      ...
      - queryIndex : qi                (int)           [create]
          Allows you to obtain a list of color names with the given color indices.                          Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def displayCull(*args, **kwargs):
    ...
    Flags:
      - backFaceCulling : bfc          (bool)          [create,query]
          Enable/disable culling of back faces.                     Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def displayRGBColor(*args, **kwargs):
    ...
    Flags:
      ...
      - hueSaturationValue : hsv       (bool)          [create,query]
          ...
          RGB values for the color.  (Between 0-1)                          Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def displaySmoothness(*args, **kwargs):
    ...
    Flags:
      ...
      - polygonObject : po             (int)           [create,query]
          Display the polygon objects with the given resolution                     Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def displaySurface(*args, **kwargs):
    ...
    Flags:
      ...
      - twoSidedLighting : two         (bool)          [query]
          ...
          lighting and back face cull to improve performance.                       Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def distanceDimension(*args, **kwargs):
    ...
    Flags:
      - endPoint : ep                  (float, float, float) [create]
          Specifies the point to measure distance to, from the startPoint.                          Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def editDisplayLayerMembers(*args, **kwargs):
    ...
    Flags:
      - fullNames : fn                 (bool)          [query]
          ...
          object.                                           Flag can have multiple arguments, passed either as a tuple or a list.
...
def evalDeferred(*args, **kwargs):
    ...
    Flags:
      ...
      - list : ls                      (bool)          [create]
          Return a list of the command strings that are currently pending on the idle queue.                        Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def format(*args, **kwargs):
    ...
    Flags:
      - stringArg : s                  (unicode)       [create]
          Specify the arguments for the format string.                                      Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def group(*args, **kwargs):
    ...
    Flags:
      ...
      - useAsGroup : uag               (unicode)       [create]
          ...
          any existing parents or children.                          Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def hide(*args, **kwargs):
    ...
    Flags:
      ...
      - returnHidden : rh              (bool)          [create]
          hide objects, but also return list of hidden objects.                     Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def hilite(*args, **kwargs):
    ...
    Flags:
      ...
      - toggle : tgl                   (bool)          [create]
          Toggle the hilite state of the specified objects.                         Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def inheritTransform(*args, **kwargs):
    ...
    Flags:
      ...
      - preserve : p                   (bool)          [create,query]
          preserve the objects world-space position by modifying the object(s) transformation matrix.                       Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def isConnected(*args, **kwargs):
    ...
    Flags:
      - ignoreUnitConversion : iuc     (bool)          [create]
          In looking for connections, skip past unit conversion nodes.                      Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def isDirty(*args, **kwargs):
    ...
    Flags:
      - connection : c                 (bool)          [create]
          Check the connection of the plug (default).                       Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def isolateSelect(*args, **kwargs):
    ...
    Flags:
      ...
      - update : u                     (bool)          []
          Update the view's list of objects due to a change to the set of objects to be displayed.                          Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def itemFilterAttr(*args, **kwargs):
    ...
    Flags:
      ...
      - listOtherFilters : lof         (bool)          [query]
          Returns an array of all attribute filters with classification other.                      Flag can have multiple
          arguments, passed either as a tuple or a list.
      ...
      - secondScript : ss              (unicode)       [create,query,edit]
          ...
          take in a list of attributes, and return a filtered list of attributes.
...
def itemFilterRender(*args, **kwargs):
    ...
    Flags:
      ...
      - exclusiveLights : exl          (bool)          [create,query,edit]
          Pass exclusive light objects if set to true.  Value is false by default.  To get all objects that are not exclusive
          lights then set this flag to true and use the -neg/negateflag to invert the result.
      ...
      - lights : l                     (bool)          [create,query,edit]
          Pass light objects if set to true.  Value is false by default.  To get all objects that are not lights then set this
          flag to true and use the -neg/negateflag to invert the result.
    
      - linkedLights : ll              (bool)          [create,query,edit]
          Pass linked light objects if set to true.  Value is false by default.  To get all objects that are not linked lights
      ...
      - postProcess : pp               (bool)          [create,query,edit]
          Pass post process objects if set to true.  Value is false by default.  To get all objects that are not post processes
          then set this flag to true and use the -neg/negateflag to invert the result.
      ...
      - renderableObjectSets : ros     (bool)          [create,query,edit]
          Pass renderable object sets if set to true.  Value is false by default.  To get all objects that are not renderable
          object sets then set this flag to true and use the -neg/negateflag to invert the result.
      ...
      - textures2d : t2d               (bool)          [create,query,edit]
          Pass 2D texture objects if set to true.  Value is false by default.  To get all objects that are not 2D textures then
          set this flag to true and use the -neg/negateflag to invert the result.
    
      - textures3d : t3d               (bool)          [create,query,edit]
          Pass 3D texture objects if set to true.  Value is false by default.  To get all objects that are not 3D textures then
          set this flag to true and use the -neg/negateflag to invert the result.
      ...
      - texturesProcedural : tp        (bool)          [create,query,edit]
          ...
          textures then set this flag to true and use the -neg/negateflag to invert the result.                     Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def itemFilterType(*args, **kwargs):
    ...
    Flags:
      - text : t                       (unicode)       [query,edit]
          Defines an annotation string to be stored with the filter                         Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def listAttr(*args, **kwargs):
    ...
    Flags:
      ...
      - usedAsFilename : uf            (bool)          [create]
          list only attributes which are designated to be treated as filenames                      Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def listRelatives(*args, **kwargs):
    ...
    Flags:
      ...
      - type : typ                     (unicode)       [create]
          List all relatives of the specified type.                         Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def listSets(*args, **kwargs):
    ...
    Flags:
      ...
      - object : o                     (PyNode)        [create]
          Returns all sets which this object is a member of.                        Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def ls(*args, **kwargs):
    ...
    Flags:
      ...
      - type : typ                     (unicode)       [create]
          ...
          used in conjunction with the -exactType flag.
...
def makeIdentity(*args, **kwargs):
    ...
    Flags:
      ...
      - normal : n                     (int)           [create]
          ...
          to freeze normals.                      Flag can have multiple arguments, passed either as a tuple or a list.
...
def makePaintable(*args, **kwargs):
    ...
    Flags:
      ...
      - activateAll : aca              (bool)          [create,query]
          ...
          tool.                                         Flag can have multiple arguments, passed either as a tuple or a list.
...
def move(*args, **kwargs):
    ...
    Flags:
      ...
      - preserveUV : puv               (bool)          [create]
          ...
          vertices. Default is false.                      Flag can have multiple arguments, passed either as a tuple or a list.
...
def objectCenter(*args, **kwargs):
    ...
    Flags:
      - gl : gl                        (bool)          [create]
          Return positional values in global coordinates (default).                         Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def objectType(*args, **kwargs):
    ...
    Flags:
      ...
      - tagFromType : tgt              (unicode)       [create]
          Returns the type tag given a type name.                   Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def paramLocator(*args, **kwargs):
    ...
    Flags:
      - position : p                   (bool)          [create]
          Whether to set the locator position in normalized space.                          Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def parent(*args, **kwargs):
    ...
    Flags:
      ...
      - noConnections : nc             (bool)          [create]
          ...
          the shading engine for new instances) This flag supresses this behaviour and is primarily used by the file format.
          Flag can have multiple arguments, passed either as a tuple or a list.
...
def pause(*args, **kwargs):
    ...
    Flags:
      - seconds : sec                  (int)           [create]
          Pause for the specified number of seconds.                        Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def performanceOptions(*args, **kwargs):
    ...
    Flags:
      ...
      - disableTrimDisplay : dt        (unicode)       [query]
          ...
          on, off, interactive.                    Flag can have multiple arguments, passed either as a tuple or a list.
...
def pickWalk(*args, **kwargs):
    ...
    Flags:
      ...
      - type : typ                     (unicode)       [create]
          The choices are nodes | instances | edgeloop | edgering | faceloop | keys | latticepoints. If type is nodes, then the
          left and right direction walk to the next dag siblings. If type is instances, the left and right direction walk to the
          previous or next instance of the same dag node. If type is edgeloop, then the edge loop starting at the first selected
          edge will be selected. If type is edgering, then the edge ring starting at the first selected edge will be selected. If
          type is faceloop, and there are two connected quad faces selected which define a face loop, then that face loop will be
          selected.  edgeloop, edgering and faceloop all remember which was the first edge or faces selected for as long as
          consecutive selections are made by this command.  They use this information to determine what the nextloop or ring
          selection should be.  Users can make selections forwards and backwards by using the direction flag with leftor right.
          Default is nodes.                         Flag can have multiple arguments, passed either as a tuple or a list.
...
def relationship(*args, **kwargs):
    ...
    have a specific type. During file read, maya will make the connections necessary to represent the realtionship in the
    dependency graph.
    
    Flags:
      - b : b                          (bool)          [create,query,edit]
          Break the specified relationship instead of creating it                                           Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def removeMultiInstance(*args, **kwargs):
    ...
    Flags:
      - b : b                          (bool)          [create]
          ...
          the command will fail if the element is connected.                         Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def rename(obj, newname, **kwargs):
    ...
    Flags:
      - ignoreShape : ignoreShape      (bool)          [create]
          Indicates that renaming of shape nodes below transform nodes should be prevented.                         Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def reorder(*args, **kwargs):
    ...
    Flags:
      ...
      - relative : r                   (int)           [create]
          Move object(s) relative to other siblings.                        Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def reorderContainer(*args, **kwargs):
    ...
    Flags:
      ...
      - relative : r                   (int)           [create,query,edit]
          Move object(s) relative to other container contents                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def scaleComponents(*args, **kwargs):
    ...
    Flags:
      ...
      - rotation : ro                  (float, float, float) [create]
          The rotational offset for the scaling (default is none)                   Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def select(*args, **kwargs):
    ...
    Flags:
      ...
      - containerCentric : cc          (bool)          [create]
          ...
          Maya will not select them. Instead, their first parent valid for selection will be selected.                        Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def selectKey(*args, **kwargs):
    ...
    Flags:
      ...
      - unsnappedKeys : uk             (float)         [create]
          Select only keys that have times that are not a multiple of the specified numeric value.                          Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def selectMode(*args, **kwargs):
    ...
    Flags:
      ...
      - template : t                   (bool)          [create,query]
          ...
          closest to the root of the hierarchy.
...
def selectPref(*args, **kwargs):
    ...
    Flags:
      ...
      - autoSelectContainer : asc      (bool)          [query]
          ...
          container node will automatically be selected as well.                       Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def selectPriority(*args, **kwargs):
    ...
    Flags:
      ...
      - animBreakdown : abd            (int)           [create,query]
          Set animation breakdown selection priority                        Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def selectType(*args, **kwargs):
    ...
    Flags:
      ...
      - animBreakdown : abd            (bool)          [create,query]
          Set animation breakdown selection mask on/off.                    Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def selectionConnection(*args, **kwargs):
    ...
    Flags:
      ...
      - addScript : addScript          (callable)      [create,query,edit]
      ...
      - deselect : d                   (PyNode)        [create,edit]
          Remove something from the selection.                      Flag can have multiple arguments, passed either as a tuple or
          a list.
      ...
      - removeScript : rs              (callable)      [create,query,edit]
...
def showHidden(*args, **kwargs):
    ...
    Flags:
      ...
      - below : b                      (bool)          [create]
          make objects and all their invisible decendents visible                   Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def snapMode(*args, **kwargs):
    ...
    Flags:
      ...
      - distanceIncrement : dsi        (float)         [create,query]
          Set the distance for the snapping to objects such as a lines or planes.                   Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def softSelect(*args, **kwargs):
    ...
    Flags:
      ...
      - softSelectReset : ssr          (bool)          [create,edit]
          Resets soft selection to its default settings.                    Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def stringArrayIntersector(*args, **kwargs):
    ...
    Flags:
      ...
      - reset : r                      (bool)          [edit]
          Reset the intersector to begin a new intersection.                        Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def symmetricModelling(*args, **kwargs):
    ...
    Flags:
      ...
      - seamFalloffCurve : sf          (unicode)       [create,query,edit]
          ...
          used.                   Flag can have multiple arguments, passed either as a tuple or a list.
...
def threadCount(*args, **kwargs):
    ...
    Flags:
      - numberOfThreads : n            (int)           [create,query]
          Sets the number of threads to use                         Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def toggle(*args, **kwargs):
    ...
    Flags:
      ...
      - highPrecisionNurbs : hpn       (bool)          [create,query]
          Toggle high precision display for Nurbs                   Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def ungroup(*args, **kwargs):
    ...
    Flags:
      - absolute : a                   (bool)          [create]
          preserve existing world object transformations (overall object transformation is preserved by modifying the objects
          local transformation) [default]                       Flag can have multiple arguments, passed either as a tuple or a
          list.
