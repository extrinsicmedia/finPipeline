...
MGL_ARB_depth_texture = 1

MGL_ARB_shadow = 1

MGL_ARB_shadow_ambient = 1

MGL_ARB_texture_env_dot3 = 1
...
MGL_CLIENT_PIXEL_STORE_BIT = 1

MGL_CLIENT_VERTEX_ARRAY_BIT = 2
...
MGL_IBM_TEXTURE_MIRRORED_REPEAT = 1
...
kMGLext_ATI_fragment_shader = 57
...
kMGLext_MGLX_choose_fbconfig = 76

kMGLext_MGLX_choose_fbconfig_sgix = 81

kMGLext_MGLX_create_context_with_config_sgix = 82

kMGLext_MGLX_create_new_context = 77

kMGLext_MGLX_create_pbuffer = 75

kMGLext_MGLX_create_pbuffer_sgix = 80

kMGLext_MGLX_destroy_pbuffer = 79

kMGLext_MGLX_destroy_window = 78

kMGLext_MGLX_get_visual_from_fbconfig_sgix = 83

kMGLext_NUMBER_OF_EXTENSIONS = 84

kMGLext_NV_fence = 58

kMGLext_NV_float_buffer = 47

kMGLext_NV_fragment_program = 63

kMGLext_NV_occlusion_query = 64

kMGLext_NV_primitive_restart = 65

kMGLext_NV_register_combiners = 59

kMGLext_NV_texture_shader = 60

kMGLext_NV_vertex_array_range = 61

kMGLext_NV_vertex_program = 62

kMGLext_SGIS_generate_mipmap = 66

kMGLext_SGIX_depth_texture = 35

kMGLext_SGIX_shadow = 36

kMGLext_WMGL_ARB_buffer_region = 69

kMGLext_WMGL_ARB_extensions_string = 68

kMGLext_WMGL_ARB_make_current_read = 72

kMGLext_WMGL_ARB_pbuffer = 70

kMGLext_WMGL_ARB_pixel_format = 71

kMGLext_WMGL_ARB_render_texture = 73

kMGLext_WMGL_NV_allocate_memory = 74
...
kMGLext_draw_range_elements = 1

kMGLext_frame_buffer_object = 67
...
kMGLext_multisample = 9

kMGLext_multitexture = 8

kMGLext_packed_pixels = 2

kMGLext_rescale_normal = 3

kMGLext_separate_specular_color = 4
...
kMGLext_texture_lod = 7

kMGLext_transpose_matrix = 16
