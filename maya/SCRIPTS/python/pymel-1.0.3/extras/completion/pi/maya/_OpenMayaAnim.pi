...
MAnimControl_kPlaybackViewActive = 1

MAnimControl_kPlaybackViewAll = 0

MFnAnimCurve_kAnimCurveTA = 0

MFnAnimCurve_kAnimCurveTL = 1

MFnAnimCurve_kAnimCurveTT = 2
...
MFnAnimCurve_kConstant = 0

MFnAnimCurve_kCycle = 3

MFnAnimCurve_kCycleRelative = 4

MFnAnimCurve_kLinear = 1

MFnAnimCurve_kOscillate = 5

MFnAnimCurve_kTangentClamped = 8

MFnAnimCurve_kTangentFast = 7

MFnAnimCurve_kTangentFixed = 1

MFnAnimCurve_kTangentFlat = 3

MFnAnimCurve_kTangentGlobal = 0

MFnAnimCurve_kTangentLinear = 2

MFnAnimCurve_kTangentPlateau = 9

MFnAnimCurve_kTangentSlow = 6

MFnAnimCurve_kTangentSmooth = 4

MFnAnimCurve_kTangentStep = 5

MFnAnimCurve_kTangentStepNext = 10

MFnBlendShapeDeformer_kFrontOfChain = 0

MFnBlendShapeDeformer_kLocalOrigin = 0

MFnBlendShapeDeformer_kNormal = 1

MFnBlendShapeDeformer_kWorldOrigin = 1

MFnIkHandle_kStickyOff = 0

MFnIkHandle_kStickyOn = 1

MFnIkHandle_kSuperSticky = 2
...
MFnKeyframeDeltaAddRemove_kAdded = 0

MFnKeyframeDeltaAddRemove_kRemoved = 1

MFnKeyframeDeltaAddRemove_kReplaced = 2

MFnKeyframeDeltaBlockAddRemove_kAdded = 0

MFnKeyframeDeltaBlockAddRemove_kRemoved = 1

MFnMotionPath_kXaxis = 0

MFnMotionPath_kYaxis = 1

MFnMotionPath_kZaxis = 2

MItKeyframe_kTangentClamped = 8

MItKeyframe_kTangentFast = 7

MItKeyframe_kTangentFixed = 1

MItKeyframe_kTangentFlat = 3

MItKeyframe_kTangentGlobal = 0

MItKeyframe_kTangentLinear = 2

MItKeyframe_kTangentPlateau = 9

MItKeyframe_kTangentSlow = 6

MItKeyframe_kTangentSmooth = 4

MItKeyframe_kTangentStep = 5

MItKeyframe_kTangentStepNext = 10
