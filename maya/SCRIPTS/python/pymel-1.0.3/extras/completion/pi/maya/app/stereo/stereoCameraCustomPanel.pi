...
def preferenceColor(*args):
    """
    Set the current viewport color to match the color that is defined
...
def swapEye(*args):
    """
    Swap the even-odd/left-right eye convention for Horizontal Interlaced &
    Checkerboard mode.
    """
