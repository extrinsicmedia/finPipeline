...
MFnFluid_kNoFalloffGrid = 0

MFnFluid_kStaticColorGrid = 1

MFnFluid_kStaticFalloffGrid = 1

MFnFluid_kStaticGrid = 1

MFnFluid_kUseShadingColor = 0

MFnFluid_kXGradient = 1

MFnFluid_kYGradient = 2

MFnFluid_kZGradient = 3

MFnFluid_kZero = 0

MFnParticleSystem_kBlobby = 2

MFnParticleSystem_kCloud = 0

MFnParticleSystem_kMultiPoint = 3

MFnParticleSystem_kMultiStreak = 4

MFnParticleSystem_kNumeric = 5

MFnParticleSystem_kPoints = 6

MFnParticleSystem_kSpheres = 7

MFnParticleSystem_kSprites = 8

MFnParticleSystem_kStreak = 9

MFnParticleSystem_kTube = 1
