...
def MFnAttribute_setParent(*args, **kwargs):
    pass
...
MAttributeIndex_kFloat = 1

MAttributeIndex_kInteger = 0
...
MCommandMessage_kDisplay = 1

MCommandMessage_kError = 4

MCommandMessage_kHistory = 0

MCommandMessage_kInfo = 2

MCommandMessage_kResult = 5

MCommandMessage_kStackTrace = 6

MCommandMessage_kWarning = 3

MCommandResult_kDouble = 3

MCommandResult_kDoubleArray = 4

MCommandResult_kInt = 1

MCommandResult_kIntArray = 2

MCommandResult_kInvalid = 0

MCommandResult_kMatrix = 9

MCommandResult_kMatrixArray = 10

MCommandResult_kString = 5

MCommandResult_kStringArray = 6

MCommandResult_kVector = 7

MCommandResult_kVectorArray = 8

MDagMessage_kChildAdded = 2

MDagMessage_kChildRemoved = 3

MDagMessage_kChildReordered = 4

MDagMessage_kInstanceAdded = 5

MDagMessage_kInstanceRemoved = 6

MDagMessage_kInvalidMsg = -1

MDagMessage_kLast = 7

MDagMessage_kParentAdded = 0

MDagMessage_kParentRemoved = 1

MDistance_kCentimeters = 6

MDistance_kFeet = 2

MDistance_kInches = 1

MDistance_kInvalid = 0

MDistance_kKilometers = 7
...
MDistance_kMillimeters = 5

MDistance_kYards = 3

MEulerRotation_kXYZ = 0

MEulerRotation_kXZY = 3

MEulerRotation_kYXZ = 4

MEulerRotation_kYZX = 1

MEulerRotation_kZXY = 2

MEulerRotation_kZYX = 5

MFileIO_kLoadAllReferences = 1

MFileIO_kLoadDefault = 0

MFileIO_kLoadNoReferences = 2

MFileObject_kBaseName = 32

MFileObject_kDirMap = 4

MFileObject_kExact = 2
...
MFileObject_kReferenceMappings = 8

MFileObject_kRelative = 16

MFileObject_kStrict = 6
...
MFnArrayAttrsData_kDoubleArray = 2

MFnArrayAttrsData_kIntArray = 3

MFnArrayAttrsData_kInvalid = 0

MFnArrayAttrsData_kLast = 5

MFnArrayAttrsData_kStringArray = 4

MFnArrayAttrsData_kVectorArray = 1

MFnAttribute_kDelete = 0

MFnAttribute_kNothing = 2

MFnAttribute_kReset = 1

MFnCamera_kFillFilmFit = 0

MFnCamera_kHorizontalFilmFit = 1

MFnCamera_kInvalid = 4

MFnCamera_kOverscanFilmFit = 3

MFnCamera_kRotateTranslate = 0

MFnCamera_kTranslateRotate = 1

MFnCamera_kVerticalFilmFit = 2

MFnContainerNode_kChildAnchor = 1

MFnContainerNode_kGeneric = 2

MFnContainerNode_kParentAnchor = 0

MFnDagNode_kNextPos = 255

MFnData_kComponentList = 11

MFnData_kDoubleArray = 7

MFnData_kDynArrayAttrs = 17

MFnData_kDynSweptGeometry = 18
...
MFnData_kNurbsCurve = 14

MFnData_kNurbsSurface = 15

MFnData_kPlugin = 2

MFnData_kPluginGeometry = 3

MFnData_kPointArray = 9

MFnData_kSphere = 16

MFnData_kString = 4

MFnData_kStringArray = 6

MFnData_kSubdSurface = 19

MFnData_kVectorArray = 10

MFnDependencyNode_kInvalidAttr = 3

MFnDependencyNode_kLocalDynamicAttr = 1

MFnDependencyNode_kNormalAttr = 2

MFnDependencyNode_kTimerInvalidState = 3

MFnDependencyNode_kTimerMetric_callback = 0

MFnDependencyNode_kTimerMetric_callbackNotViaAPI = 6

MFnDependencyNode_kTimerMetric_callbackViaAPI = 5

MFnDependencyNode_kTimerMetric_compute = 1

MFnDependencyNode_kTimerMetric_computeDuringCallback = 7

MFnDependencyNode_kTimerMetric_computeNotDuringCallback = 8

MFnDependencyNode_kTimerMetric_dirty = 2

MFnDependencyNode_kTimerMetric_draw = 3

MFnDependencyNode_kTimerMetric_fetch = 4

MFnDependencyNode_kTimerOff = 0

MFnDependencyNode_kTimerOn = 1

MFnDependencyNode_kTimerType_count = 2

MFnDependencyNode_kTimerType_inclusive = 1

MFnDependencyNode_kTimerType_self = 0

MFnDependencyNode_kTimerUninitialized = 2

MFnExpression_kAll = 0

MFnExpression_kAngularOnly = 2

MFnExpression_kNone = 1

MFnMatrixAttribute_kDouble = 1

MFnMatrixAttribute_kFloat = 0

MFnMesh_kAlpha = 1

MFnMesh_kDifference = 2

MFnMesh_kInternalPoint = 1

MFnMesh_kIntersection = 1
...
MFnNumericData_k2Double = 14

MFnNumericData_k2Float = 11

MFnNumericData_k2Int = 8

MFnNumericData_k2Long = 8

MFnNumericData_k2Short = 5

MFnNumericData_k3Double = 15

MFnNumericData_k3Float = 12

MFnNumericData_k3Int = 9

MFnNumericData_k3Long = 9

MFnNumericData_k3Short = 6

MFnNumericData_k4Double = 16

MFnNumericData_kAddr = 17

MFnNumericData_kBoolean = 1

MFnNumericData_kByte = 2

MFnNumericData_kChar = 3

MFnNumericData_kDouble = 13

MFnNumericData_kFloat = 10

MFnNumericData_kInt = 7

MFnNumericData_kInvalid = 0

MFnNumericData_kLast = 18

MFnNumericData_kLong = 7

MFnNumericData_kShort = 4

MFnNurbsCurve_kClosed = 2

MFnNurbsCurve_kInvalid = 0

MFnNurbsCurve_kLast = 4

MFnNurbsCurve_kOpen = 1

MFnNurbsCurve_kPeriodic = 3

MFnNurbsSurface_kClosed = 2

MFnNurbsSurface_kClosedSegment = 4

MFnNurbsSurface_kInner = 2

MFnNurbsSurface_kInvalid = 0

MFnNurbsSurface_kInvalidBoundary = 0

MFnNurbsSurface_kLast = 4

MFnNurbsSurface_kOpen = 1

MFnNurbsSurface_kOuter = 1

MFnNurbsSurface_kPeriodic = 3

MFnNurbsSurface_kSegment = 3

MFnPartition_kEdgesOnly = 2

MFnPartition_kEditPointsOnly = 4

MFnPartition_kFacetsOnly = 3

MFnPartition_kNone = 0

MFnPartition_kRenderableOnly = 5

MFnPartition_kVerticesOnly = 1

MFnSet_kEdgesOnly = 2

MFnSet_kEditPointsOnly = 4

MFnSet_kFacetsOnly = 3

MFnSet_kNone = 0

MFnSet_kRenderableOnly = 5

MFnSet_kVerticesOnly = 1

MFnSpotLight_kBottom = 3

MFnSpotLight_kFirst = 0

MFnSpotLight_kLeft = 0

MFnSpotLight_kRight = 1

MFnSpotLight_kSecond = 1

MFnSpotLight_kThird = 2

MFnSpotLight_kTop = 2

MFnTransform_kRotateMaxX = 13

MFnTransform_kRotateMaxY = 15

MFnTransform_kRotateMaxZ = 17

MFnTransform_kRotateMinX = 12

MFnTransform_kRotateMinY = 14

MFnTransform_kRotateMinZ = 16

MFnTransform_kScaleMaxX = 1

MFnTransform_kScaleMaxY = 3

MFnTransform_kScaleMaxZ = 5

MFnTransform_kScaleMinX = 0

MFnTransform_kScaleMinY = 2

MFnTransform_kScaleMinZ = 4

MFnTransform_kShearMaxXY = 7

MFnTransform_kShearMaxXZ = 9

MFnTransform_kShearMaxYZ = 11

MFnTransform_kShearMinXY = 6

MFnTransform_kShearMinXZ = 8

MFnTransform_kShearMinYZ = 10

MFnTransform_kTranslateMaxX = 19

MFnTransform_kTranslateMaxY = 21

MFnTransform_kTranslateMaxZ = 23

MFnTransform_kTranslateMinX = 18

MFnTransform_kTranslateMinY = 20

MFnTransform_kTranslateMinZ = 22

MFnUnitAttribute_kAngle = 1

MFnUnitAttribute_kDistance = 2

MFnUnitAttribute_kInvalid = 0

MFnUnitAttribute_kLast = 4

MFnUnitAttribute_kTime = 3

MFnVolumeLight_kBoxVolume = 0

MFnVolumeLight_kConeVolume = 3

MFnVolumeLight_kCylinderVolume = 2

MFnVolumeLight_kDownAxis = 2

MFnVolumeLight_kInward = 1

MFnVolumeLight_kOutward = 0

MFnVolumeLight_kSphereVolume = 1

MFn_kAISEnvFacade = 954

MFn_kAddDoubleLinear = 5

MFn_kAdskMaterial = 1041
...
MFn_kAmbientLight = 302

MFn_kAngle = 269

MFn_kAngleBetween = 21

MFn_kAnimBlend = 776

MFn_kAnimBlendInOut = 777

MFn_kAnimCurve = 7

MFn_kAnimCurveTimeToAngular = 8

MFn_kAnimCurveTimeToDistance = 9

MFn_kAnimCurveTimeToTime = 10

MFn_kAnimCurveTimeToUnitless = 11

MFn_kAnimCurveUnitlessToAngular = 12

MFn_kAnimCurveUnitlessToDistance = 13

MFn_kAnimCurveUnitlessToTime = 14

MFn_kAnimCurveUnitlessToUnitless = 15
...
MFn_kAttribute2Double = 732

MFn_kAttribute2Float = 733

MFn_kAttribute2Int = 735

MFn_kAttribute2Long = 735

MFn_kAttribute2Short = 734

MFn_kAttribute3Double = 736

MFn_kAttribute3Float = 737

MFn_kAttribute3Int = 739

MFn_kAttribute3Long = 739

MFn_kAttribute3Short = 738

MFn_kAttribute4Double = 861
...
MFn_kBaseLattice = 248

MFn_kBendLattice = 334
...
MFn_kBezierCurve = 1028

MFn_kBezierCurveData = 1029

MFn_kBezierCurveToNurbs = 1031
...
MFn_kBlendNodeAdditiveRotation = 1008

MFn_kBlendNodeAdditiveScale = 1007

MFn_kBlendNodeBase = 996

MFn_kBlendNodeBoolean = 997

MFn_kBlendNodeDouble = 998

MFn_kBlendNodeDoubleAngle = 999

MFn_kBlendNodeDoubleLinear = 1000

MFn_kBlendNodeEnum = 1001

MFn_kBlendNodeFloat = 1002

MFn_kBlendNodeFloatAngle = 1003

MFn_kBlendNodeFloatLinear = 1004

MFn_kBlendNodeInt16 = 1005

MFn_kBlendNodeInt32 = 1006
...
MFn_kBlindDataTemplate = 742

MFn_kBlinn = 364

MFn_kBlinnMaterial = 379
...
MFn_kCharacterMap = 785

MFn_kCharacterMappingData = 727

MFn_kCharacterOffset = 674
...
MFn_kCircleSweepManip = 128

MFn_kClampColor = 39

MFn_kClip = 791

MFn_kClipLibrary = 765

MFn_kClipScheduler = 764

MFn_kCloseCurve = 55

MFn_kCloseSurface = 57

MFn_kClosestPointOnMesh = 966

MFn_kClosestPointOnSurface = 56
...
MFn_kClusterFilter = 343

MFn_kClusterFlexor = 299

MFn_kCoiManip = 155

MFn_kCollision = 252

MFn_kColorBackground = 24

MFn_kColorProfile = 1040

MFn_kCommCornerManip = 599

MFn_kCommCornerOperManip = 600

MFn_kCommEdgeOperManip = 597

MFn_kCommEdgePtManip = 596

MFn_kCommEdgeSegmentManip = 598

MFn_kComponent = 523

MFn_kComponentListData = 571

MFn_kComponentManip = 660

MFn_kCompoundAttribute = 563
...
MFn_kContainerBase = 1042

MFn_kContrast = 38

MFn_kControl = 474

MFn_kCopyColorSet = 723
...
MFn_kCreateBPManip = 818

MFn_kCreateBezierManip = 1027

MFn_kCreateCVManip = 157

MFn_kCreateColorSet = 721

MFn_kCreateEPManip = 158

MFn_kCreateSectionManip = 805

MFn_kCreateUVSet = 790

MFn_kCrossSectionEditManip = 806

MFn_kCrossSectionManager = 804

MFn_kCubicProjectionManip = 130

MFn_kCurve = 265

MFn_kCurveCVComponent = 524

MFn_kCurveCurveIntersect = 627

MFn_kCurveEPComponent = 525

MFn_kCurveEdManip = 159

MFn_kCurveFromMeshCoM = 914

MFn_kCurveFromMeshEdge = 626

MFn_kCurveFromSubdivEdge = 817

MFn_kCurveFromSubdivFace = 823
...
MFn_kCurveKnotComponent = 526

MFn_kCurveNormalizerAngle = 978

MFn_kCurveNormalizerLinear = 979

MFn_kCurveParamComponent = 527
...
MFn_kDagContainer = 1043

MFn_kDagNode = 107

MFn_kDagPose = 675

MFn_kDagSelectionItem = 550

MFn_kData = 570

MFn_kData2Double = 580
...
MFn_kData4Double = 862

MFn_kDblTrsManip = 190

MFn_kDecayRegionCapComponent = 536

MFn_kDecayRegionComponent = 537

MFn_kDefaultLightList = 316

MFn_kDeformBend = 611

MFn_kDeformBendManip = 617

MFn_kDeformFlare = 614

MFn_kDeformFlareManip = 620

MFn_kDeformFunc = 610

MFn_kDeformSine = 615

MFn_kDeformSineManip = 621

MFn_kDeformSquash = 613

MFn_kDeformSquashManip = 619

MFn_kDeformTwist = 612

MFn_kDeformTwistManip = 618

MFn_kDeformWave = 616

MFn_kDeformWaveManip = 622

MFn_kDeleteColorSet = 722

MFn_kDeleteComponent = 317

MFn_kDeleteUVSet = 782

MFn_kDependencyNode = 4

MFn_kDetachCurve = 63

MFn_kDetachSurface = 64

MFn_kDiffuseMaterial = 377

MFn_kDimension = 268

MFn_kDimensionManip = 232

MFn_kDirectedDisc = 275

MFn_kDirectionManip = 161

MFn_kDirectionalLight = 307

MFn_kDiscManip = 132

MFn_kDiskCache = 844

MFn_kDispatchCompute = 318

MFn_kDisplacementShader = 320

MFn_kDisplayLayer = 718

MFn_kDisplayLayerManager = 719

MFn_kDistance = 271

MFn_kDistanceBetween = 321

MFn_kDistanceManip = 624

MFn_kDofManip = 162

MFn_kDoubleAngleAttribute = 555

MFn_kDoubleArrayData = 572

MFn_kDoubleIndexedComponent = 699

MFn_kDoubleLinearAttribute = 557

MFn_kDoubleShadingSwitch = 605

MFn_kDrag = 257

MFn_kDropOffFunction = 807

MFn_kDropoffLocator = 281

MFn_kDropoffManip = 163

MFn_kDummy = 253

MFn_kDummyConnectable = 323

MFn_kDynAirManip = 709

MFn_kDynArrayAttrsData = 714

MFn_kDynAttenuationManip = 713

MFn_kDynBase = 705

MFn_kDynBaseFieldManip = 708

MFn_kDynEmitterManip = 706

MFn_kDynFieldsManip = 707

MFn_kDynGlobals = 754

MFn_kDynNewtonManip = 710

MFn_kDynParticleSetComponent = 548

MFn_kDynSpreadManip = 712

MFn_kDynSweptGeometryData = 728

MFn_kDynTurbulenceManip = 711

MFn_kDynamicConstraint = 968

MFn_kDynamicsController = 324

MFn_kEdgeComponent = 533

MFn_kEditCurve = 802

MFn_kEditCurveManip = 803

MFn_kEmitter = 254

MFn_kEnableManip = 136

MFn_kEnumAttribute = 560
...
MFn_kEnvFogMaterial = 371

MFn_kEnvFogShape = 277

MFn_kEnvSky = 482

MFn_kEnvSphere = 483

MFn_kExplodeNurbsShell = 677
...
MFn_kExtendSurfaceDistanceManip = 701
...
MFn_kFfdDualBase = 338

MFn_kField = 255

MFn_kFileBackground = 25

MFn_kFileTexture = 488

MFn_kFilletCurve = 70

MFn_kFilter = 328

MFn_kFilterClosestSample = 329

MFn_kFilterEuler = 330

MFn_kFilterSimplify = 331
...
MFn_kFloatAngleAttribute = 556

MFn_kFloatArrayData = 1012

MFn_kFloatLinearAttribute = 558

MFn_kFloatMatrixAttribute = 567

MFn_kFloatVectorArrayData = 989
...
MFn_kFluidEmitter = 900

MFn_kFluidGeom = 895

MFn_kFluidTexture2D = 889

MFn_kFluidTexture3D = 888

MFn_kFollicle = 915

MFn_kForceUpdateManip = 680

MFn_kFourByFourMatrix = 760

MFn_kFractal = 489

MFn_kFreePointManip = 133

MFn_kFreePointTriadManip = 137

MFn_kGammaCorrect = 332

MFn_kGenericAttribute = 564

MFn_kGeoConnectable = 325

MFn_kGeoConnector = 902

MFn_kGeometric = 264

MFn_kGeometryConstraint = 113

MFn_kGeometryData = 697

MFn_kGeometryFilt = 333

MFn_kGeometryOnLineManip = 142

MFn_kGeometryVarGroup = 114

MFn_kGlobalCacheControls = 843

MFn_kGlobalStitch = 686
...
MFn_kHairConstraint = 920

MFn_kHairSystem = 916

MFn_kHairTubeShader = 927

MFn_kHandleRotateManip = 216

MFn_kHardenPointCurve = 73

MFn_kHardwareReflectionMap = 867

MFn_kHardwareRenderGlobals = 515

MFn_kHeightField = 901

MFn_kHikEffector = 940

MFn_kHikFloorContactMarker = 960

MFn_kHikGroundPlane = 961

MFn_kHikHandle = 942

MFn_kHikSolver = 941

MFn_kHistorySwitch = 965

MFn_kHsvToRgb = 350

MFn_kHwShaderNode = 870

MFn_kHyperGraphInfo = 351

MFn_kHyperLayout = 352

MFn_kHyperLayoutDG = 980
...
MFn_kIllustratorCurve = 74

MFn_kImageAdd = 645

MFn_kImageBlur = 651

MFn_kImageColorCorrect = 650
...
MFn_kImageDisplay = 654

MFn_kImageFilter = 652

MFn_kImageLoad = 640

MFn_kImageMotionBlur = 656

MFn_kImageMultiply = 647

MFn_kImageNetDest = 643

MFn_kImageNetSrc = 642

MFn_kImageOver = 648

MFn_kImagePlane = 361

MFn_kImageRender = 644
...
MFn_kImplicitCone = 875

MFn_kImplicitSphere = 876
...
MFn_kIntArrayData = 573

MFn_kIntersectSurface = 77

MFn_kInvalid = 0

MFn_kIsoparmComponent = 528

MFn_kIsoparmManip = 146

MFn_kItemList = 552

MFn_kJiggleDeformer = 842

MFn_kJoint = 121

MFn_kJointCluster = 345

MFn_kJointClusterManip = 168

MFn_kJointTranslateManip = 229

MFn_kKeyframeDelta = 929

MFn_kKeyframeDeltaAddRemove = 932

MFn_kKeyframeDeltaBlockAddRemove = 933

MFn_kKeyframeDeltaBreakdown = 937

MFn_kKeyframeDeltaInfType = 934

MFn_kKeyframeDeltaMove = 930

MFn_kKeyframeDeltaScale = 931

MFn_kKeyframeDeltaTangent = 935

MFn_kKeyframeDeltaWeighted = 936

MFn_kKeyframeRegionManip = 977

MFn_kLambert = 362

MFn_kLambertMaterial = 378

MFn_kLast = 1045

MFn_kLattice = 278

MFn_kLatticeComponent = 534

MFn_kLatticeData = 574

MFn_kLatticeGeom = 279

MFn_kLayeredShader = 367

MFn_kLayeredTexture = 786

MFn_kLeastSquares = 369

MFn_kLeather = 500

MFn_kLight = 301

MFn_kLightDataAttribute = 565

MFn_kLightFogMaterial = 370
...
MFn_kLightSource = 373

MFn_kLightSourceMaterial = 381
...
MFn_kLineModifier = 955

MFn_kLinearLight = 305

MFn_kLocator = 280

MFn_kLodGroup = 758

MFn_kLodThresholds = 756
...
MFn_kMaterialFacade = 952

MFn_kMaterialInfo = 382

MFn_kMatrixAdd = 383

MFn_kMatrixAttribute = 566

MFn_kMatrixData = 575

MFn_kMatrixFloatData = 658
...
MFn_kMatrixWtAdd = 387

MFn_kMembrane = 1013

MFn_kMentalRayTexture = 922

MFn_kMergeVertsToolManip = 1014

MFn_kMesh = 295

MFn_kMeshComponent = 538

MFn_kMeshData = 576

MFn_kMeshEdgeComponent = 539

MFn_kMeshFaceVertComponent = 543

MFn_kMeshFrEdgeComponent = 541

MFn_kMeshGeom = 296

MFn_kMeshMapComponent = 798

MFn_kMeshPolygonComponent = 540

MFn_kMeshVarGroup = 117

MFn_kMeshVertComponent = 542

MFn_kMeshVtxFaceComponent = 730

MFn_kMessageAttribute = 568

MFn_kMidModifier = 388

MFn_kMidModifierWithMatrix = 389

MFn_kModel = 3

MFn_kModifyEdgeBaseManip = 819

MFn_kModifyEdgeCrvManip = 810

MFn_kModifyEdgeManip = 811
...
MFn_kMoveUVShellManip2D = 695

MFn_kMoveVertexManip = 748

MFn_kMultDoubleLinear = 759

MFn_kMultiSubVertexComponent = 546

MFn_kMultilisterLight = 435

MFn_kMultiplyDivide = 436
...
MFn_kNearestPointOnCurve = 1039

MFn_kNewton = 259

MFn_kNoise = 860

MFn_kNonAmbientLight = 303

MFn_kNonDagSelectionItem = 551

MFn_kNonExtendedLight = 306
...
MFn_kNumericAttribute = 554

MFn_kNumericData = 579

MFn_kNurbsBoolean = 678

MFn_kNurbsCircular2PtArc = 629

MFn_kNurbsCircular3PtArc = 628

MFn_kNurbsCube = 80

MFn_kNurbsCurve = 266

MFn_kNurbsCurveData = 578

MFn_kNurbsCurveGeom = 267

MFn_kNurbsCurveToBezier = 1030

MFn_kNurbsPlane = 79

MFn_kNurbsSquare = 607

MFn_kNurbsSurface = 293

MFn_kNurbsSurfaceData = 577

MFn_kNurbsSurfaceGeom = 294

MFn_kNurbsTesselate = 78

MFn_kNurbsToSubdiv = 745

MFn_kObjectAttrFilter = 666

MFn_kObjectBinFilter = 923

MFn_kObjectFilter = 662

MFn_kObjectMultiFilter = 663

MFn_kObjectNameFilter = 664

MFn_kObjectRenderFilter = 667

MFn_kObjectScriptFilter = 668

MFn_kObjectTypeFilter = 665

MFn_kOcean = 856

MFn_kOceanShader = 879
...
MFn_kOffsetSurface = 630

MFn_kOffsetSurfaceManip = 638

MFn_kOldGeometryConstraint = 437

MFn_kOpticalFX = 438

MFn_kOrientConstraint = 239

MFn_kOrientationComponent = 544

MFn_kOrientationLocator = 285

MFn_kOrientationMarker = 283
...
MFn_kParamDimension = 274

MFn_kParentConstraint = 241

MFn_kParticle = 310

MFn_kParticleAgeMapper = 439

MFn_kParticleCloud = 440

MFn_kParticleColorMapper = 441

MFn_kParticleIncandecenceMapper = 442

MFn_kParticleSamplerInfo = 788

MFn_kParticleTransparencyMapper = 443

MFn_kPartition = 444

MFn_kPassContributionMap = 772

MFn_kPfxGeometry = 925
...
MFn_kPhongExplorer = 366

MFn_kPhongMaterial = 380

MFn_kPivotComponent = 529

MFn_kPivotManip2D = 191

MFn_kPlace2dTexture = 445

MFn_kPlace3dTexture = 446

MFn_kPlanarProjectionManip = 207

MFn_kPlanarTrimSrf = 83

MFn_kPlane = 287

MFn_kPlugin = 569

MFn_kPluginCameraSet = 987

MFn_kPluginConstraintNode = 992

MFn_kPluginData = 588

MFn_kPluginDeformerNode = 601

MFn_kPluginDependNode = 447

MFn_kPluginEmitterNode = 716

MFn_kPluginFieldNode = 715

MFn_kPluginGeometryData = 752

MFn_kPluginHardwareShader = 871

MFn_kPluginHwShaderNode = 872

MFn_kPluginIkSolver = 746

MFn_kPluginImagePlaneNode = 981

MFn_kPluginLocatorNode = 448

MFn_kPluginManipContainer = 681

MFn_kPluginManipulatorNode = 1009

MFn_kPluginObjectSet = 904

MFn_kPluginParticleAttributeMapperNode = 985

MFn_kPluginShape = 696

MFn_kPluginSpringNode = 717

MFn_kPluginTransformNode = 893

MFn_kPlusMinusAverage = 449

MFn_kPointArrayData = 589
...
MFn_kPointOnPolyConstraint = 1034

MFn_kPointOnSurfaceInfo = 85

MFn_kPointOnSurfaceManip = 212

MFn_kPoleVectorConstraint = 242

MFn_kPolyAppend = 392

MFn_kPolyAppendVertex = 778

MFn_kPolyArrow = 956

MFn_kPolyAutoProj = 832

MFn_kPolyAutoProjManip = 944

MFn_kPolyAverageVertex = 831

MFn_kPolyBevel = 390

MFn_kPolyBlindData = 743

MFn_kPolyBoolOp = 603

MFn_kPolyBridgeEdge = 970

MFn_kPolyChipOff = 393

MFn_kPolyCloseBorder = 394

MFn_kPolyCollapseEdge = 395

MFn_kPolyCollapseF = 396

MFn_kPolyColorDel = 726

MFn_kPolyColorMod = 725

MFn_kPolyColorPerVertex = 720

MFn_kPolyComponentData = 962

MFn_kPolyCone = 426

MFn_kPolyConnectComponents = 1035

MFn_kPolyCreaseEdge = 939

MFn_kPolyCreateFacet = 432

MFn_kPolyCreateToolManip = 140

MFn_kPolyCreator = 424

MFn_kPolyCube = 427

MFn_kPolyCut = 882

MFn_kPolyCutManip = 886

MFn_kPolyCutManipContainer = 885

MFn_kPolyCylProj = 397

MFn_kPolyCylinder = 428

MFn_kPolyDelEdge = 398

MFn_kPolyDelFacet = 399

MFn_kPolyDelVertex = 400

MFn_kPolyDuplicateEdge = 950

MFn_kPolyEdgeToCurve = 994

MFn_kPolyExtrudeEdge = 775

MFn_kPolyExtrudeFacet = 401

MFn_kPolyExtrudeVertex = 906

MFn_kPolyFlipEdge = 774

MFn_kPolyFlipUV = 869

MFn_kPolyHelix = 963

MFn_kPolyHoleFace = 1033

MFn_kPolyLayoutUV = 833
...
MFn_kPolyMapSewMove = 834

MFn_kPolyMappingManip = 194

MFn_kPolyMergeEdge = 405

MFn_kPolyMergeFacet = 406

MFn_kPolyMergeUV = 890

MFn_kPolyMergeVert = 683
...
MFn_kPolyMoveEdge = 407

MFn_kPolyMoveFacet = 408

MFn_kPolyMoveFacetUV = 409

MFn_kPolyMoveUV = 410

MFn_kPolyMoveUVManip = 193

MFn_kPolyMoveVertex = 411

MFn_kPolyMoveVertexManip = 196

MFn_kPolyMoveVertexUV = 412

MFn_kPolyNormal = 413

MFn_kPolyNormalPerVertex = 744

MFn_kPolyNormalizeUV = 868

MFn_kPolyPipe = 959

MFn_kPolyPlanProj = 414

MFn_kPolyPlatonicSolid = 958

MFn_kPolyPoke = 883

MFn_kPolyPokeManip = 887

MFn_kPolyPrimitive = 425

MFn_kPolyPrimitiveMisc = 957
...
MFn_kPolyPyramid = 946

MFn_kPolyQuad = 416

MFn_kPolyReduce = 755

MFn_kPolySelectEditFeedbackManip = 1017

MFn_kPolySeparate = 451

MFn_kPolySewEdge = 682

MFn_kPolySmooth = 417

MFn_kPolySmoothFacet = 684

MFn_kPolySmoothProxy = 924

MFn_kPolySoftEdge = 418

MFn_kPolySphProj = 419

MFn_kPolySphere = 430

MFn_kPolySpinEdge = 1032

MFn_kPolySplit = 420

MFn_kPolySplitEdge = 796

MFn_kPolySplitRing = 947

MFn_kPolySplitToolManip = 141

MFn_kPolySplitVert = 792

MFn_kPolyStraightenUVBorder = 891

MFn_kPolySubdEdge = 421

MFn_kPolySubdFacet = 422

MFn_kPolyToSubdiv = 671

MFn_kPolyToolFeedbackManip = 1016

MFn_kPolyToolFeedbackShape = 311

MFn_kPolyTorus = 431

MFn_kPolyTransfer = 830

MFn_kPolyTriangulate = 423

MFn_kPolyTweak = 391

MFn_kPolyTweakUV = 694

MFn_kPolyUVRectangle = 1044

MFn_kPolyUnite = 433

MFn_kPolyVertexNormalManip = 197

MFn_kPolyWedgeFace = 884

MFn_kPositionMarker = 284

MFn_kPostProcessList = 452

MFn_kPrecompExport = 773
...
MFn_kProxyManager = 943

MFn_kPsdFileTexture = 928

MFn_kQuadPtOnLineManip = 179

MFn_kQuadShadingSwitch = 905
...
MFn_kRenderGlobals = 511

MFn_kRenderGlobalsList = 512

MFn_kRenderLayer = 770

MFn_kRenderLayerManager = 771

MFn_kRenderPass = 768

MFn_kRenderPassSet = 769

MFn_kRenderQuality = 513

MFn_kRenderRect = 276

MFn_kRenderSetup = 510

MFn_kRenderSphere = 297

MFn_kRenderUtilityList = 455

MFn_kResolution = 514

MFn_kResultCurve = 16

MFn_kResultCurveTimeToAngular = 17

MFn_kResultCurveTimeToDistance = 18

MFn_kResultCurveTimeToTime = 19

MFn_kResultCurveTimeToUnitless = 20
...
MFn_kRigidConstraint = 312

MFn_kRigidDeform = 339

MFn_kRigidSolver = 458
...
MFn_kRotateUVManip2D = 692

MFn_kRoundConstantRadius = 631

MFn_kRoundConstantRadiusManip = 634

MFn_kRoundRadiusCrvManip = 633

MFn_kRoundRadiusManip = 632

MFn_kSCsolver = 357

MFn_kSPbirailSrf = 52

MFn_kSamplerInfo = 466

MFn_kScaleConstraint = 243

MFn_kScaleLimitsManip = 218

MFn_kScaleManip = 219

MFn_kScalePointManip = 812

MFn_kScaleUVManip2D = 693
...
MFn_kSectionManip = 799

MFn_kSelectionItem = 549

MFn_kSelectionList = 594

MFn_kSelectionListData = 661

MFn_kSelectionListOperator = 669

MFn_kSequenceManager = 1024

MFn_kSequencer = 1025

MFn_kSet = 459

MFn_kSetGroupComponent = 547

MFn_kSetRange = 462

MFn_kSfRevolveManip = 822

MFn_kShaderGlow = 463

MFn_kShaderList = 464

MFn_kShadingEngine = 319

MFn_kShadingMap = 465

MFn_kShape = 247

MFn_kShapeFragment = 467

MFn_kShot = 1026

MFn_kSimpleVolumeShader = 468

MFn_kSingleIndexedComponent = 698

MFn_kSingleShadingSwitch = 604

MFn_kSketchPlane = 288

MFn_kSkin = 100

MFn_kSkinBinding = 1036

MFn_kSkinClusterFilter = 672
...
MFn_kSmoothCurve = 685

MFn_kSmoothTangentSrf = 767

MFn_kSnapshot = 470

MFn_kSnapshotPath = 903

MFn_kSnapshotShape = 840

MFn_kSnow = 503

MFn_kSoftMod = 251

MFn_kSoftModFilter = 344

MFn_kSoftModManip = 623

MFn_kSolidFractal = 504
...
MFn_kSquareSrfManip = 703

MFn_kStateManip = 145

MFn_kStencil = 493

MFn_kStereoCameraMaster = 1023

MFn_kStitchAsNurbsShell = 676

MFn_kStitchSrf = 101

MFn_kStitchSrfManip = 679

MFn_kStoryBoard = 471

MFn_kStringArrayData = 592

MFn_kStringData = 591

MFn_kStringShadingSwitch = 898

MFn_kStroke = 749

MFn_kStrokeGlobals = 751

MFn_kStucco = 505

MFn_kStudioClearCoat = 899
...
MFn_kSubVertexComponent = 545

MFn_kSubdAddTopology = 873

MFn_kSubdAutoProj = 858

MFn_kSubdBlindData = 784

MFn_kSubdBoolean = 808

MFn_kSubdCleanTopology = 874

MFn_kSubdCloseBorder = 845

MFn_kSubdDelFace = 839

MFn_kSubdExtrudeFace = 820

MFn_kSubdHierBlind = 783

MFn_kSubdLayoutUV = 854

MFn_kSubdMapCut = 853

MFn_kSubdMapSewMove = 855

MFn_kSubdMappingManip = 866

MFn_kSubdMergeVert = 846

MFn_kSubdModifier = 835

MFn_kSubdModifyEdge = 809

MFn_kSubdMoveEdge = 837

MFn_kSubdMoveFace = 838

MFn_kSubdMoveVertex = 836

MFn_kSubdPlanProj = 863

MFn_kSubdProjectionManip = 865

MFn_kSubdSplitFace = 850

MFn_kSubdSubdivideFace = 859

MFn_kSubdTweak = 864

MFn_kSubdTweakUV = 852

MFn_kSubdiv = 670

MFn_kSubdivCVComponent = 687

MFn_kSubdivCollapse = 787

MFn_kSubdivCompId = 780

MFn_kSubdivData = 793

MFn_kSubdivEdgeComponent = 688

MFn_kSubdivFaceComponent = 689

MFn_kSubdivGeom = 794

MFn_kSubdivMapComponent = 841

MFn_kSubdivReverseFaces = 797

MFn_kSubdivSurfaceVarGroup = 821

MFn_kSubdivToNurbs = 801

MFn_kSubdivToPoly = 704

MFn_kSummaryObject = 472

MFn_kSuper = 473

MFn_kSurface = 292

MFn_kSurfaceCVComponent = 530

MFn_kSurfaceEPComponent = 531

MFn_kSurfaceEdManip = 762

MFn_kSurfaceFaceComponent = 763

MFn_kSurfaceInfo = 103

MFn_kSurfaceKnotComponent = 532

MFn_kSurfaceLuminance = 475

MFn_kSurfaceRangeComponent = 535

MFn_kSurfaceShader = 476

MFn_kSurfaceVarGroup = 118

MFn_kSymmetryLocator = 814

MFn_kSymmetryMapCurve = 816

MFn_kSymmetryMapVector = 815

MFn_kTangentConstraint = 244
...
MFn_kTextureBakeSet = 460

MFn_kTextureEnv = 478

MFn_kTextureList = 477

MFn_kTextureManip3D = 223

MFn_kThreePointArcManip = 635

MFn_kTime = 508

MFn_kTimeAttribute = 559

MFn_kTimeFunction = 921

MFn_kTimeToUnitConversion = 509

MFn_kToggleManip = 224

MFn_kToggleOnLineManip = 144

MFn_kToonLineAttributes = 949

MFn_kTorus = 602

MFn_kTowPointManip = 139

MFn_kTowPointOnCurveManip = 209

MFn_kTowPointOnSurfaceManip = 761

MFn_kTransferAttributes = 967

MFn_kTransform = 110

MFn_kTransformBoxManip = 813

MFn_kTransformGeometry = 595
...
MFn_kTranslateUVManip2D = 691

MFn_kTriadManip = 237

MFn_kTrim = 105

MFn_kTrimLocator = 286

MFn_kTrimManip = 228

MFn_kTrimWithBoundaries = 913

MFn_kTriplanarProjectionManip = 188

MFn_kTripleIndexedComponent = 700

MFn_kTripleShadingSwitch = 606
...
MFn_kTwoPointArcManip = 636

MFn_kTxSl = 506

MFn_kTypedAttribute = 562

MFn_kUInt64ArrayData = 795

MFn_kUVManip2D = 690

MFn_kUint64SingleIndexedComponent = 1015

MFn_kUnderWorld = 109

MFn_kUniform = 262

MFn_kUnitAttribute = 561

MFn_kUnitConversion = 517

MFn_kUnitToTimeConversion = 518

MFn_kUnknown = 520

MFn_kUnknownDag = 315

MFn_kUnknownTransform = 245
...
MFn_kUseBackground = 519

MFn_kUvChooser = 779

MFn_kVectorArrayData = 593

MFn_kVectorProduct = 521

MFn_kVertexBakeSet = 461

MFn_kVertexWeightSet = 1038

MFn_kViewColorManager = 657

MFn_kViewManip = 909

MFn_kVolumeAxis = 781

MFn_kVolumeBindManip = 1037

MFn_kVolumeFog = 851

MFn_kVolumeLight = 878

MFn_kVolumeNoise = 857

MFn_kVolumeShader = 522

MFn_kVortex = 263

MFn_kWater = 494

MFn_kWeightGeometryFilt = 342
...
MFn_kWriteToColorBuffer = 1019

MFn_kWriteToDepthBuffer = 1021

MFn_kWriteToFrameBuffer = 1018

MFn_kWriteToLabelBuffer = 1022

MFn_kWriteToVectorBuffer = 1020

MFn_kXformManip = 910

MFn_kXsectionSubdivEdit = 800

MGlobal_kAddToHeadOfList = 4

MGlobal_kAddToList = 2

MGlobal_kBaseUIMode = 3

MGlobal_kBatch = 1

MGlobal_kInteractive = 0

MGlobal_kLibraryApp = 2

MGlobal_kRemoveFromList = 3

MGlobal_kReplaceList = 0

MGlobal_kSelectComponentMode = 1

MGlobal_kSelectLeafMode = 3

MGlobal_kSelectObjectMode = 0

MGlobal_kSelectRootMode = 2

MGlobal_kSelectTemplateMode = 4

MGlobal_kSurfaceSelectMethod = 0

MGlobal_kWireframeSelectMethod = 1

MGlobal_kXORWithList = 1

MImageFileInfo_kHwTexture1D = 1

MImageFileInfo_kHwTexture2D = 2

MImageFileInfo_kHwTexture3D = 3

MImageFileInfo_kHwTextureCubeMap = 5

MImageFileInfo_kHwTextureRectangle = 4

MImageFileInfo_kHwTextureUnknown = 0

MImageFileInfo_kImageTypeBump = 3

MImageFileInfo_kImageTypeColor = 1

MImageFileInfo_kImageTypeNormal = 2

MImageFileInfo_kImageTypeUnknown = 0

MImage_kByte = 1

MImage_kFloat = 2

MImage_kHeightFieldBumpFormat = 1

MImage_kNoFormat = 0

MImage_kNormalMapBumpFormat = 2

MImage_kUnknown = 0

MImage_kUnknownFormat = 3

MItDag_kBreadthFirst = 2

MItDag_kDepthFirst = 1

MItDag_kInvalidType = 0

MItDependencyGraph_kBreadthFirst = 1

MItDependencyGraph_kDepthFirst = 0

MItDependencyGraph_kDownstream = 0

MItDependencyGraph_kNodeLevel = 0

MItDependencyGraph_kPlugLevel = 1

MItDependencyGraph_kUpstream = 1

MItSelectionList_kAnimSelectionItem = 1

MItSelectionList_kDNselectionItem = 2

MItSelectionList_kDagSelectionItem = 0

MItSelectionList_kPlugSelectionItem = 3

MItSelectionList_kUnknownItem = -1

MIteratorType_kMDagPathObject = 1

MIteratorType_kMObject = 0

MIteratorType_kMPlugObject = 2

MLockMessage_kAddAttr = 5

MLockMessage_kChildReorder = 4

MLockMessage_kCreateChildInstance = 6

MLockMessage_kCreateNodeInstance = 5

MLockMessage_kCreateParentInstance = 7

MLockMessage_kDelete = 2

MLockMessage_kGroup = 1

MLockMessage_kInvalid = 0

MLockMessage_kInvalidDAG = 0

MLockMessage_kInvalidPlug = 0

MLockMessage_kLast = 10

MLockMessage_kLastDAG = 8

MLockMessage_kLastPlug = 8

MLockMessage_kLockAttr = 9

MLockMessage_kLockNode = 3

MLockMessage_kPlugAttrValChange = 3

MLockMessage_kPlugConnect = 6

MLockMessage_kPlugDisconnect = 7

MLockMessage_kPlugLockAttr = 1

MLockMessage_kPlugRemoveAttr = 4

MLockMessage_kPlugRenameAttr = 5

MLockMessage_kPlugUnlockAttr = 2

MLockMessage_kRemoveAttr = 6

MLockMessage_kRename = 1

MLockMessage_kRenameAttr = 7

MLockMessage_kReparent = 3

MLockMessage_kUnGroup = 2

MLockMessage_kUnlockAttr = 8

MLockMessage_kUnlockNode = 4

MMatrix_kTol = None

MMeshSmoothOptions_kCreaseAll = 1

MMeshSmoothOptions_kCreaseEdge = 2

MMeshSmoothOptions_kInvalid = -1

MMeshSmoothOptions_kLast = 3

MMeshSmoothOptions_kLegacy = 0

MModelMessage_kActiveListModified = 0

MNodeMessage_kAttributeAdded = 64

MNodeMessage_kAttributeArrayAdded = 4096

MNodeMessage_kAttributeArrayRemoved = 8192

MNodeMessage_kAttributeEval = 4

MNodeMessage_kAttributeKeyable = 512

MNodeMessage_kAttributeLocked = 16

MNodeMessage_kAttributeRemoved = 128

MNodeMessage_kAttributeRenamed = 256

MNodeMessage_kAttributeSet = 8

MNodeMessage_kAttributeUnkeyable = 1024

MNodeMessage_kAttributeUnlocked = 32

MNodeMessage_kConnectionBroken = 2

MNodeMessage_kConnectionMade = 1

MNodeMessage_kIncomingDirection = 2048

MNodeMessage_kKeyChangeInvalid = 0

MNodeMessage_kKeyChangeLast = 3

MNodeMessage_kLast = 32768

MNodeMessage_kMakeKeyable = 1

MNodeMessage_kMakeUnkeyable = 2
...
MPlug_kChildrenNotFreeToChange = 2

MPlug_kFreeToChange = 0

MPlug_kLastAttrSelector = 3

MPlug_kNonDefault = 1

MPlug_kNotFreeToChange = 1

MPoint_kTol = None

MPolyMessage_kEdgeIndex = 1

MPolyMessage_kFaceIndex = 2

MPolyMessage_kLastErrorIndex = 3

MPolyMessage_kVertexIndex = 0

MRampAttribute_kLinear = 0

MRampAttribute_kNone = 1

MRampAttribute_kSmooth = 3

MRampAttribute_kSpline = 2

MSceneMessage_kAfterCreateReference = 42

MSceneMessage_kAfterExport = 8

MSceneMessage_kAfterExportReference = 18

MSceneMessage_kAfterImport = 4

MSceneMessage_kAfterImportReference = 16

MSceneMessage_kAfterLoadReference = 34

MSceneMessage_kAfterNew = 2

MSceneMessage_kAfterOpen = 6

MSceneMessage_kAfterPluginLoad = 38

MSceneMessage_kAfterPluginUnload = 40

MSceneMessage_kAfterReference = 12

MSceneMessage_kAfterRemoveReference = 14

MSceneMessage_kAfterSave = 10

MSceneMessage_kAfterSoftwareFrameRender = 24

MSceneMessage_kAfterSoftwareRender = 22

MSceneMessage_kAfterUnloadReference = 20

MSceneMessage_kBeforeCreateReference = 41

MSceneMessage_kBeforeCreateReferenceCheck = 36

MSceneMessage_kBeforeExport = 7

MSceneMessage_kBeforeExportCheck = 32

MSceneMessage_kBeforeExportReference = 17

MSceneMessage_kBeforeImport = 3

MSceneMessage_kBeforeImportCheck = 31

MSceneMessage_kBeforeImportReference = 15

MSceneMessage_kBeforeLoadReference = 33

MSceneMessage_kBeforeLoadReferenceCheck = 35

MSceneMessage_kBeforeNew = 1

MSceneMessage_kBeforeNewCheck = 28

MSceneMessage_kBeforeOpen = 5

MSceneMessage_kBeforeOpenCheck = 29

MSceneMessage_kBeforePluginLoad = 37

MSceneMessage_kBeforePluginUnload = 39

MSceneMessage_kBeforeReference = 11

MSceneMessage_kBeforeReferenceCheck = 36

MSceneMessage_kBeforeRemoveReference = 13

MSceneMessage_kBeforeSave = 9

MSceneMessage_kBeforeSaveCheck = 30

MSceneMessage_kBeforeSoftwareFrameRender = 23

MSceneMessage_kBeforeSoftwareRender = 21

MSceneMessage_kBeforeUnloadReference = 19

MSceneMessage_kLast = 43

MSceneMessage_kMayaExiting = 27

MSceneMessage_kMayaInitialized = 26

MSceneMessage_kSceneUpdate = 0

MSceneMessage_kSoftwareRenderInterrupted = 25

MSelectionList_kMergeNormal = 0

MSelectionList_kRemoveFromList = 2

MSelectionList_kXORWithList = 1

MSelectionMask_kSelectAnimAny = 68

MSelectionMask_kSelectAnimCurves = 63

MSelectionMask_kSelectAnimInTangents = 65

MSelectionMask_kSelectAnimKeyframes = 64

MSelectionMask_kSelectAnimMask = 67

MSelectionMask_kSelectAnimOutTangents = 66

MSelectionMask_kSelectCVs = 30

MSelectionMask_kSelectCameras = 6

MSelectionMask_kSelectClusters = 8

MSelectionMask_kSelectCollisionModels = 21

MSelectionMask_kSelectComponentsMask = 62

MSelectionMask_kSelectCurveKnots = 47

MSelectionMask_kSelectCurveParmPoints = 46

MSelectionMask_kSelectCurves = 26

MSelectionMask_kSelectCurvesOnSurfaces = 53

MSelectionMask_kSelectDynamicConstraints = 82

MSelectionMask_kSelectEdges = 42

MSelectionMask_kSelectEditPoints = 32

MSelectionMask_kSelectEmitters = 16

MSelectionMask_kSelectFacets = 43

MSelectionMask_kSelectFields = 17

MSelectionMask_kSelectFluids = 77

MSelectionMask_kSelectFollicles = 79

MSelectionMask_kSelectGuideLines = 71

MSelectionMask_kSelectHairSystems = 78

MSelectionMask_kSelectHandles = 0

MSelectionMask_kSelectHulls = 31

MSelectionMask_kSelectIkEndEffectors = 3

MSelectionMask_kSelectIkHandles = 2

MSelectionMask_kSelectIsoparms = 52

MSelectionMask_kSelectJointPivots = 57

MSelectionMask_kSelectJoints = 4

MSelectionMask_kSelectLatticePoints = 55

MSelectionMask_kSelectLattices = 7

MSelectionMask_kSelectLights = 5

MSelectionMask_kSelectLocalAxis = 1

MSelectionMask_kSelectLocators = 28

MSelectionMask_kSelectManipulators = 70

MSelectionMask_kSelectMeshComponents = 45

MSelectionMask_kSelectMeshEdges = 34

MSelectionMask_kSelectMeshFaces = 36

MSelectionMask_kSelectMeshFreeEdges = 35

MSelectionMask_kSelectMeshLines = 44

MSelectionMask_kSelectMeshUVs = 40

MSelectionMask_kSelectMeshVerts = 33

MSelectionMask_kSelectMeshes = 12

MSelectionMask_kSelectNCloths = 80

MSelectionMask_kSelectNParticles = 83

MSelectionMask_kSelectNRigids = 81

MSelectionMask_kSelectNurbsCurves = 10

MSelectionMask_kSelectNurbsSurfaces = 11

MSelectionMask_kSelectObjectGroups = 75

MSelectionMask_kSelectObjectsMask = 29

MSelectionMask_kSelectOrientationLocators = 23

MSelectionMask_kSelectPPStrokes = 54

MSelectionMask_kSelectParticleShapes = 15

MSelectionMask_kSelectParticles = 56

MSelectionMask_kSelectPivots = 60

MSelectionMask_kSelectPointsForGravity = 72

MSelectionMask_kSelectPointsOnCurvesForGravity = 73

MSelectionMask_kSelectPointsOnSurfacesForGravity = 74

MSelectionMask_kSelectRigidBodies = 19

MSelectionMask_kSelectRigidConstraints = 20

MSelectionMask_kSelectRotatePivots = 59

MSelectionMask_kSelectScalePivots = 58

MSelectionMask_kSelectSculpts = 9

MSelectionMask_kSelectSelectHandles = 61

MSelectionMask_kSelectSketchPlanes = 14

MSelectionMask_kSelectSprings = 18

MSelectionMask_kSelectSubdiv = 13

MSelectionMask_kSelectSubdivMeshEdges = 38

MSelectionMask_kSelectSubdivMeshFaces = 39

MSelectionMask_kSelectSubdivMeshMaps = 76

MSelectionMask_kSelectSubdivMeshPoints = 37

MSelectionMask_kSelectSurfaceEdge = 51

MSelectionMask_kSelectSurfaceKnots = 49

MSelectionMask_kSelectSurfaceParmPoints = 48

MSelectionMask_kSelectSurfaceRange = 50

MSelectionMask_kSelectSurfaces = 27

MSelectionMask_kSelectTemplates = 69

MSelectionMask_kSelectTextures = 25

MSelectionMask_kSelectUVLocators = 24

MSelectionMask_kSelectVertices = 41

MSelectionMask_kSelectXYZLocators = 22
...
MSpace_kPostTransform = 3

MSpace_kPreTransform = 2

MSpace_kTransform = 1

MSpace_kWorld = 4

MStatus_kEndOfFile = 8

MStatus_kFailure = 1

MStatus_kInsufficientMemory = 2

MStatus_kInvalidParameter = 3

MStatus_kLicenseFailure = 4

MStatus_kNotFound = 7

MStatus_kNotImplemented = 6
...
MSyntax_kInvalidArgType = 0

MSyntax_kInvalidObjectFormat = 0

MSyntax_kLastArgType = 11

MSyntax_kLastObjectFormat = 4
...
MSyntax_kSelectionItem = 10

MSyntax_kSelectionList = 3

MSyntax_kString = 5

MSyntax_kStringObjects = 2

MSyntax_kTime = 9

MSyntax_kUnsigned = 6

MTesselationParams_kGeneralFormat = 2

MTesselationParams_kLastFlag = 11

MTesselationParams_kQuads = 1

MTesselationParams_kSpanEquiSpaced = 3

MTesselationParams_kStandardFitFormat = 1

MTesselationParams_kSurface3DDistance = 0

MTesselationParams_kSurface3DEquiSpaced = 1

MTesselationParams_kSurfaceEquiSpaced = 2

MTesselationParams_kTriangleCountFormat = 0

MTesselationParams_kTriangles = 0

MTesselationParams_kUseChordHeightRatio = 1

MTesselationParams_kUseEdgeSmooth = 10

MTesselationParams_kUseFractionalTolerance = 0

MTesselationParams_kUseMaxEdgeLength = 3

MTesselationParams_kUseMaxNumberPolys = 4

MTesselationParams_kUseMaxSubdivisionLevel = 5

MTesselationParams_kUseMaxUVRectangleSize = 7

MTesselationParams_kUseMinEdgeLength = 2

MTesselationParams_kUseMinScreenSize = 6

MTesselationParams_kUseRelativeTolerance = 9

MTesselationParams_kUseTriangleEdgeSwapping = 8
...
MTransformationMatrix_kInvalid = 0

MTransformationMatrix_kLast = 7

MTransformationMatrix_kTol = None

MTransformationMatrix_kXYZ = 1

MTransformationMatrix_kXZY = 4

MTransformationMatrix_kYXZ = 5

MTransformationMatrix_kYZX = 2

MTransformationMatrix_kZXY = 3

MTransformationMatrix_kZYX = 6
