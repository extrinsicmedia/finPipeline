...
class MayaTestRunner(TextTestRunner):
    def __init__(self, stream='<maya.Output object at 0x2cdc150>', descriptions=True, verbosity=2):
        pass
...
def setupUnittestModule(moduleName, suiteFuncName='suite', testMainName='test_main', filterTestCases='<function startsWithDoubleUnderscore at 0xd949ed8>'):
    """
