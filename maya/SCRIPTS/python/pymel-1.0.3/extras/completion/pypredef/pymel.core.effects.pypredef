...
def collision(*args, **kwargs):
    ...
    Flags:
      - friction : f                   (float)         [query,edit]
          ...
          cause the particle to reflect straight along the normal of the surface.                        Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def colorAtPoint(*args, **kwargs):
    """
    The colorAtPointcommand is used to query textures or ocean           shaders at passed in uv coordinates. (For ocean
    shaders uv is x and z in           worldspace ).           The return value is a floating point array whose size is
...
def connectDynamic(*args, **kwargs):
    ...
    Flags:
      ...
      - delete : d                     (bool)          [create]
          Deletes existing connections.                     Flag can have multiple arguments, passed either as a tuple or a list.
...
def constrain(*args, **kwargs):
    ...
    Flags:
      ...
      - interpenetrate : i             (bool)          [create,query,edit]
          Allows (or disallows) the rigid bodies defined in the constrain to ipenetrate.                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def dynExport(*args, **kwargs):
    ...
    Flags:
      ...
      - format : f                     (unicode)       [create]
          ...
          called readpdbwhich reads it. Note that you must compile and run reapdb on the platform which you exported the files on.
          Flag can have multiple arguments, passed either as a tuple or a list.
      ...
      - path : p                       (unicode)       [create]
          ...
          particlesand add it to your workspace.
...
def dynExpression(*args, **kwargs):
    ...
    Flags:
      ...
      - runtimeAfterDynamics : rad     (bool)          [create,query,edit]
          ...
          executed after dynamics whenever a particle's age is greater then zero (0).                        Flag can have
...
def dynPref(*args, **kwargs):
    ...
    Flags:
      ...
      - echoCollision : ec             (bool)          [create,query]
          ...
          collision event. If off, only the output of the command will be echoed.                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def emit(*args, **kwargs):
    ...
    Flags:
      ...
      - floatValue : fv                (float)         [create]
          ...
          the vector.                    Flag can have multiple arguments, passed either as a tuple or a list.
      ...
      - vectorValue : vv               (float, float, float) [create]
          ...
          length is described as SQR( xVal2+ yVal2+ zVal2.
...
def emitter(*args, **kwargs):
    ...
    Flags:
      ...
      - scaleRateByObjectSize : sro    (bool)          [query,edit]
          ...
          way Maya behaved prior to version 3.0.                     Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def event(*args, **kwargs):
    ...
    Flags:
      ...
      - proc : pr                      (callable)      [create,query,edit]
          ...
          particle's attributes.                   Flag can have multiple arguments, passed either as a tuple or a list.
...
def expressionEditorListen(*args, **kwargs):
    ...
    Flags:
      - listenFile : lf                (unicode)       [create]
          Listen for changes to the file argument.                          Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def fluidVoxelInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - radius : r                     (float)         [create]
          ...
          the point specified by the -voxel flag.                                    Flag can have multiple arguments, passed
...
def getFluidAttr(*args, **kwargs):
    ...
    Flags:
      ...
      - lowerFace : lf                 (bool)          [create]
          ...
          components on the lower left three faces of a voxel, rather than all six.                                         Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def getParticleAttr(*args, **kwargs):
    ...
    Flags:
      - array : a                      (bool)          [create]
          ...
          values: Average X, Average Y, Average Z, Maximum offset in X, Y, and Z of component.                      Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def goal(*args, **kwargs):
    ...
    Flags:
      ...
      - useTransformAsGoal : utr       (bool)          [create]
          ...
          passed once, applies to all objects passed with -g.                       Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def newton(*args, **kwargs):
    ...
    Flags:
      ...
      - minDistance : mnd              (float)         [query,edit]
          ...
          small positive number avoids bizarre behavior when the distance gets extremely small.                     Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def paintEffectsDisplay(*args, **kwargs):
    ...
    Flags:
      - meshDrawEnable : me            (bool)          [create,query]
          Set whether mesh draw is enabled on objects                                       Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def particleFill(*args, **kwargs):
    ...
    Flags:
      - closePacking : cp              (bool)          [create]
          ...
          Otherwise particles are packed in a uniform grid lattice.                                        Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def particleRenderInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - renderTypeCount : rtc          (bool)          [query]
          Return the count of registered render classes for particle.                       Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def pfxstrokes(*args, **kwargs):
    ...
    Flags:
      - filename : fn                  (unicode)       [create]
          The output file.                                          Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def resampleFluid(*args, **kwargs):
    ...
    Flags:
      - resampleDepth : rd             (int)           [create,query,edit]
          Change depth resolution to this value                                     Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def saveFluid(*args, **kwargs):
    ...
    Flags:
      ...
      - endTime : et                   (int)           [create,query,edit]
          end Time for cacheing                                     Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def saveInitialState(*args, **kwargs):
    ...
    Flags:
      - attribute : atr                (unicode)       [create]
          Save the initial state of the specified attribute only. This is a multi-use flag.                         Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def setDynamic(*args, **kwargs):
    ...
    Flags:
      ...
      - disableAllOnWhenRun : dwr      (bool)          [create]
          Obsolete, no longer suppported or necessary.                      Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def setParticleAttr(*args, **kwargs):
    ...
    Flags:
      ...
      - object : o                     (unicode)       [create]
          ...
          specified attribute.                     Flag can have multiple arguments, passed either as a tuple or a list.
