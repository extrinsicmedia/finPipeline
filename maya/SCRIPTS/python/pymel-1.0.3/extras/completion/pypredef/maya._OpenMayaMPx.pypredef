...
def MPx3dModelView_beginOverlayDrawing(*args, **kwargs):
    pass


def MPx3dModelView_clearOverlayPlane(*args, **kwargs):
    pass
...
def MPx3dModelView_endOverlayDrawing(*args, **kwargs):
    pass
...
MPx3dModelView_kFogExponential = 1

MPx3dModelView_kFogExponentialSquared = 2

MPx3dModelView_kFogFragment = 0

MPx3dModelView_kFogLinear = 0

MPx3dModelView_kLightActive = 2

MPx3dModelView_kLightAll = 0
...
MPx3dModelView_kLightSelected = 1

MPxCacheFormat_kRead = 0

MPxCacheFormat_kReadWrite = 2

MPxCacheFormat_kWrite = 1

MPxCommand_kDouble = 1

MPxCommand_kLong = 0

MPxCommand_kNoArg = 3

MPxCommand_kString = 2

MPxConstraintCommand_kGeometryShape = 1

MPxConstraintCommand_kLast = 2

MPxConstraintCommand_kTransform = 0

MPxConstraint_kLast = 4

MPxConstraint_kObject = 1

MPxConstraint_kObjectRotation = 2

MPxConstraint_kScene = 0

MPxConstraint_kVector = 3

MPxContext_kImage1 = 0

MPxContext_kImage2 = 1

MPxContext_kImage3 = 2

MPxData_kData = 0

MPxData_kGeometryData = 1

MPxData_kLast = 2

MPxDeformerNode_kDeformsAll = 6

MPxDeformerNode_kDeformsColors = 4

MPxDeformerNode_kDeformsUVs = 2

MPxEmitterNode_kCurve = 3

MPxEmitterNode_kDirectional = 0

MPxEmitterNode_kOmni = 1

MPxEmitterNode_kSurface = 2

MPxEmitterNode_kVolume = 4

MPxFileTranslator_kCouldBeMyFileType = 1

MPxFileTranslator_kExportAccessMode = 5

MPxFileTranslator_kExportActiveAccessMode = 6

MPxFileTranslator_kImportAccessMode = 3

MPxFileTranslator_kIsMyFileType = 0

MPxFileTranslator_kNotMyFileType = 2

MPxFileTranslator_kOpenAccessMode = 1

MPxFileTranslator_kReferenceAccessMode = 2

MPxFileTranslator_kSaveAccessMode = 4

MPxFileTranslator_kUnknownAccessMode = 0

MPxHardwareShader_kIsTransparent = 1

MPxHardwareShader_kNoTransparencyFrontBackCull = 2

MPxHardwareShader_kNoTransparencyPolygonSort = 4

MPxHwShaderNode_kDirtyAll = 15

MPxHwShaderNode_kDirtyColorArrays = 4

MPxHwShaderNode_kDirtyNone = 0

MPxHwShaderNode_kDirtyNormalArray = 2

MPxHwShaderNode_kDirtyTexCoordArrays = 8

MPxHwShaderNode_kDirtyVertexArray = 1

MPxHwShaderNode_kIsTransparent = 1

MPxHwShaderNode_kNoTransparencyFrontBackCull = 2

MPxHwShaderNode_kNoTransparencyPolygonSort = 4

MPxHwShaderNode_kWriteAll = 15

MPxHwShaderNode_kWriteColorArrays = 4

MPxHwShaderNode_kWriteNone = 0

MPxHwShaderNode_kWriteNormalArray = 2

MPxHwShaderNode_kWriteTexCoordArrays = 8

MPxHwShaderNode_kWriteVertexArray = 1

MPxManipContainer_kCircleSweepManip = 6

MPxManipContainer_kCurveSegmentManip = 9

MPxManipContainer_kCustomManip = 10

MPxManipContainer_kDirectionManip = 1

MPxManipContainer_kDiscManip = 5

MPxManipContainer_kDistanceManip = 2

MPxManipContainer_kFreePointTriadManip = 0

MPxManipContainer_kPointOnCurveManip = 3

MPxManipContainer_kPointOnSurfaceManip = 4

MPxManipContainer_kStateManip = 8

MPxManipContainer_kToggleManip = 7

MPxMaterialInformation_kOverrideDraw = 2

MPxMaterialInformation_kSimpleMaterial = 0

MPxMaterialInformation_kTexture = 1

MPxNode_kCameraSetNode = 16

MPxNode_kConstraintNode = 17

MPxNode_kDeformerNode = 2

MPxNode_kDependNode = 0

MPxNode_kEmitterNode = 6

MPxNode_kFieldNode = 5

MPxNode_kFluidEmitterNode = 13

MPxNode_kHardwareShader = 9

MPxNode_kHwShaderNode = 10

MPxNode_kIkSolverNode = 8

MPxNode_kImagePlaneNode = 14

MPxNode_kLast = 19

MPxNode_kLocatorNode = 1

MPxNode_kManipContainer = 3

MPxNode_kManipulatorNode = 18

MPxNode_kObjectSet = 12

MPxNode_kParticleAttributeMapperNode = 15

MPxNode_kSpringNode = 7

MPxNode_kSurfaceShape = 4

MPxNode_kTransformNode = 11

MPxRenderPassImpl_kBit = 2048

MPxRenderPassImpl_kColorSemantic = 1

MPxRenderPassImpl_kDepthSemantic = 4

MPxRenderPassImpl_kDirectionVectorSemantic = 3
...
MPxRenderPassImpl_kInt8 = 16

MPxRenderPassImpl_kInvalidSemantic = 0

MPxRenderPassImpl_kLabelSemantic = 5

MPxRenderPassImpl_kMaskSemantic = 6

MPxRenderPassImpl_kOther = 4096

MPxRenderPassImpl_kOtherSemantic = 7

MPxRenderPassImpl_kUInt16 = 2

MPxRenderPassImpl_kUInt32 = 4

MPxRenderPassImpl_kUInt64 = 8

MPxRenderPassImpl_kUInt8 = 1

MPxRenderPassImpl_kVectorSemantic = 2

MPxSurfaceShapeUI_kSelectMeshEdges = 3

MPxSurfaceShapeUI_kSelectMeshFaces = 2

MPxSurfaceShapeUI_kSelectMeshUVs = 0

MPxSurfaceShapeUI_kSelectMeshVerts = 1

MPxSurfaceShape_kBoundingBoxChanged = 1

MPxSurfaceShape_kMatchInvalidAttribute = 4

MPxSurfaceShape_kMatchInvalidAttributeDim = 7

MPxSurfaceShape_kMatchInvalidAttributeIndex = 5

MPxSurfaceShape_kMatchInvalidAttributeRange = 6

MPxSurfaceShape_kMatchInvalidName = 3

MPxSurfaceShape_kMatchNone = 1

MPxSurfaceShape_kMatchOk = 0

MPxSurfaceShape_kMatchTooMany = 2

MPxSurfaceShape_kNoPointCaching = 0

MPxSurfaceShape_kNormal = 0

MPxSurfaceShape_kObjectChanged = 0

MPxSurfaceShape_kRestorePoints = 2

MPxSurfaceShape_kSavePoints = 1

MPxSurfaceShape_kUTangent = 1

MPxSurfaceShape_kUVNTriad = 3

MPxSurfaceShape_kUpdatePoints = 3

MPxSurfaceShape_kVTangent = 2

MPxUITableControl_kAllLabels = 3

MPxUITableControl_kColumnLabel = 2

MPxUITableControl_kNoLabel = 0

MPxUITableControl_kRowLabel = 1
