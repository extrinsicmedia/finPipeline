...
def checkDefaultRenderGlobals(*args, **kwargs):
    """
    Command to check or set the changedmode for the defaultRenderGlobals node.               In query mode, return type is
    based on queried flag.
    
    Flags:
      - changed : ch                   (bool)          [create,query,edit]
          Check or set the changedmode of the defaultRenderGlobals node.                                    Flag can have multiple
...
def convertIffToPsd(*args, **kwargs):
    ...
    Flags:
      ...
      - psdFileName : pfn              (unicode)       [create,query]
          Output file name                                          Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def convertSolidTx(*args, **kwargs):
    ...
    Flags:
      ...
      - backgroundColor : bc           (int, int, int) [create]
          ...
          values range from 0 to 255. This flag automatically sets -backgroundMode to color. Default is black: 0 0 0.
      ...
      - uvRange : uvr                  (float, float, float, float) [create]
          ...
          specified. By default the entire uv range of the surface will be used.                     Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def createLayeredPsdFile(*args, **kwargs):
    ...
    Flags:
      ...
      - psdFileName : psf              (unicode)       [create]
          PSD file name.                    Flag can have multiple arguments, passed either as a tuple or a list.
...
def createRenderLayer(*args, **kwargs):
    ...
    Flags:
      ...
      - number : num                   (int)           [create]
          Number for the new render layer being created.                                    Flag can have multiple arguments,
...
def displacementToPoly(*args, **kwargs):
    ...
    Flags:
      - findBboxOnly : fbb             (bool)          [create,query,edit]
          When used, only the bounding box scale for the displaced object is found.                                         Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def doBlur(*args, **kwargs):
    ...
    Flags:
      ...
      - vectorFile : v                 (unicode)       [create]
          Name of the input motion vector file.                     Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def editRenderLayerAdjustment(*args, **kwargs):
    ...
    Flags:
      ...
      - nodeLog : nlg                  (bool)          [query]
          Output all adjustments for the specified layer sorted by node name.                                       Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def editRenderLayerMembers(*args, **kwargs):
    ...
    Flags:
      ...
      - remove : r                     (bool)          [create]
          Remove the specified objects from the render layer.                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def frameBufferName(*args, **kwargs):
    ...
    Flags:
      - autoTruncate : a               (bool)          [create]
          ...
          by the destination file format, if applicable.                                    Flag can have multiple arguments,
          passed either as a tuple or a list.
      ...
      - renderLayer : l                (unicode)       [create]
          Specifiy a renderer layer
    
      - renderPass : p                 (unicode)       [create]
          Specifiy a renderer pass
...
def glRender(*args, **kwargs):
    ...
    Flags:
      ...
      - writeDepthMap : wdm            (bool)          [query,edit]
          Enable/disable writing of zdepth to image files.                          Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def hwRender(*args, **kwargs):
    ...
    Flags:
      ...
      - layer : l                      (PyNode)        [create,query]
          ...
          after the rendering.                                       Flag can have multiple arguments, passed either as a tuple or
          a list.
      ...
      - renderRegion : reg             (int, int, int, int) [create,query]
          The renderRegion flag pass the render region to the hwRender     command.  The parameters are 4 integers, indicating
          left right bottom top     of the region.
      ...
      - width : w                      (int)           [create,query]
          The width flag pass the width to the hwRender command. If not used,     the width is taken from the render globals
          settings.
...
def iprEngine(*args, **kwargs):
    ...
    Flags:
      - copy : cp                      (unicode)       [edit]
          Copies the deep raster file, as well as its related files, to the new location.                   Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def layeredTexturePort(*args, **kwargs):
    ...
    Flags:
      ...
      - selectedIsVisibleControl : svc (unicode)       [create]
          Specifies the name of the UI-control that represents the currently selected layer's visibility.                   Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def listCameras(*args, **kwargs):
    ...
    Flags:
      - orthographic : o               (bool)          [create]
          Display all orthographic cameras.                         Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def lookThru(*args, **kwargs):
    ...
    Flags:
      - farClip : fc                   (float)         [create]
          ...
          values must come before shape or view.                    Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def makebot(*args, **kwargs):
    ...
    Flags:
      ...
      - verbose : v                    (bool)          [create]
          Makebot will provide feedback if this flag is specified                   Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def nodePreset(*args, **kwargs):
    ...
    Flags:
      - attributes : atr               (unicode)       [create]
          ...
          be stored.                                       Flag can have multiple arguments, passed either as a tuple or a list.
...
def ogsRender(*args, **kwargs):
    ...
    Flags:
      - batchMode : bm                 (bool)          [create,query]
          When turned on, means the action will be run in batch mode.                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def psdChannelOutliner(*args, **kwargs):
    ...
    Flags:
      ...
      - numberOfItems : ni             (bool)          [query]
          Total number of items in the control.                     Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def psdEditTextureFile(*args, **kwargs):
    ...
    Flags:
      ...
      - deleteChannel : deleteChannel  (unicode)       [create]
          (M) Deletes the channels (layer sets) from a PSD file. This is a multiuse flag.                   Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def psdExport(*args, **kwargs):
    ...
    Flags:
      ...
      - emptyLayerSet : els            (bool)          [create,query]
          ...
          set names should be specified.                                           Flag can have multiple arguments, passed either
...
def rampColorPort(*args, **kwargs):
    ...
    Flags:
      ...
      - selectedPositionControl : sp   (unicode)       [create,edit]
          ...
          selected entry if edited. The type of control must be an attrFieldSliderGrp.                     Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def renderGlobalsNode(*args, **kwargs):
    ...
    Flags:
      ...
      - renderQuality : rq             (unicode)       [create]
          Set the quality to be the renderQuality node with the given name.                         Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def renderInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - vtype : vt                     (int)           [create]
          Tessellation subdivision criteria.                        Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def renderManip(*args, **kwargs):
    ...
    Flags:
      ...
      - light : lt                     (bool, bool, bool) [query,edit]
          ...
          center of interest, and pivot.                        Flag can have multiple arguments, passed either as a tuple or a
          list.
...
def setRenderPassType(*args, **kwargs):
    ...
    Flags:
      ...
      - numChannels : n                (int)           [create]
          ...
          implementation supporting the requested number of channels.                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def shadingNetworkCompare(*args, **kwargs):
    ...
    Flags:
      ...
      - delete : delete                (bool)          [create]
          Deletes the specified comparison from memory.                                     Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def shadingNode(*args, **kwargs):
    ...
    Flags:
      ...
      - asUtility : au                 (bool)          [create]
          classify the current DG node as a utility                         Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def spotLightPreviewPort(*args, **kwargs):
    ...
    Flags:
      ...
      - widthHeight : wh               (int, int)      [create]
          The width and height of the port.                         Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def surfaceShaderList(*args, **kwargs):
    ...
    Flags:
      ...
      - remove : rm                    (PyNode)        [create]
          remove object(s) to shader group list.                    Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def textureWindow(*args, **kwargs):
    ...
    appears at the top of the maya window. It can also be invoked by selecting the Panel -UV Texture Editoritem under the
    Panelsmenu item that appears at the top right hand corner of the view. As a UV Texture Editor typically exists at start-
    up time, and as only one of these can exist at any given time, this command is normally used to query and edit the
    editor settings.
    ...
    Flags:
      ...
      - displaySolidMap : dsm          (bool)          [create,query,edit]
          Display an solid over lay for the active texture map.                     Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def viewCamera(*args, **kwargs):
    ...
    Flags:
      ...
      - sideView : s                   (bool)          [create]
          Position camera to look at the side of the target camera.                         Flag can have multiple arguments,
          passed either as a tuple or a list.
...
def viewClipPlane(*args, **kwargs):
    ...
    Flags:
      ...
      - farClipPlane : fcp             (float)         [create,query]
          Set or query the far clip plane.                          Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def viewFit(*args, **kwargs):
    ...
    Flags:
      ...
      - animate : an                   (bool)          [create]
          Specifies that the transition between camera positions should be animated.                        Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def viewLookAt(*args, **kwargs):
    ...
    Flags:
      - position : pos                 (float, float, float) [create]
          Position in world space to make the camera look at.                       Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def viewPlace(*args, **kwargs):
    ...
    Flags:
      ...
      - upDirection : up               (float, float, float) [create]
          The new up direction vector.                      Flag can have multiple arguments, passed either as a tuple or a list.
...
def viewSet(*args, **kwargs):
    ...
    Flags:
      ...
      - fitFactor : ff                 (float)         [create]
          Specifies how much of the view should be filled with the fitteditems                      Flag can have multiple
          arguments, passed either as a tuple or a list.
